  ...
  const handleMouseOver = useCallback((containerRef) => {
    timer.current = setTimeout(() => {
      ...
      svgRefs.current.forEach((ref) => {
        if (ref.current && ref.current.parentNode === containerRef.current) {
    ...
    <>
      <div className="flex mt-6 flex-col items-center">
        ...
        <div className={`${styles.container}`}>
            ...
            <div
              ...
              <span className={styles.right}>
                <div className={styles.textContent}>
                  <h3>I18next</h3>
                  <ul>
                    <li>Internationalization framework for JavaScript</li>
                    <li>Learn once, translate everywhere</li>
                    <li>
                      Complete translation solution for web, mobile and desktop
                    </li>
                  </ul>
                </div>
                <i></i>
          ...
          <img className={styles.png} src="/Tech/techstack.png" ref={pngRef} />
        </div>
      </div>
    </>
  );
